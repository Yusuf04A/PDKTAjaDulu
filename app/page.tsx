    ...
    <div className="flex min-h-screen bg-gradient-to-br from-rose-50 via-pink-50 to-red-50">
      ...
      <main className="flex-1 lg:ml-64">
        ...
        <section className="relative overflow-hidden px-6 py-16 md:py-24">
          ...
          <div
            className="absolute top-60 right-40 opacity-10"
          ...
          <div className="max-w-6xl mx-auto relative z-10">
            <div className="text-center space-y-6 mb-16">
              ...
              <p className="text-xl md:text-2xl text-gray-600 max-w-2xl mx-auto text-balance leading-relaxed">
                Crush kok di tebak? Sini deh, biar AI bantu baca sinyal doi. Gak
                pake ribet, sat-set!
              </p>
              ...
              <div className="grid grid-cols-3 gap-8 text-center">
                <div className="space-y-2">
                  <div className="flex items-center justify-center gap-2">
                    <Star
                      className="text-rose-600 animate-pulse-glow"
                      size={24}
                    />
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-center gap-2">
                    <Zap
                      className="text-pink-600 animate-pulse-glow"
                      size={24}
                    />
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-center gap-2">
                    <Heart
                      className="text-red-600 animate-heart-beat"
                      size={24}
                    />
        ...
        <section className="relative px-6 py-20 bg-white">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl md:text-5xl font-black text-rose-950 mb-4">
                Mengapa Memilih PDKT Aja Dulu?
              </h2>
              <p className="text-xl text-gray-600 max-w-2xl mx-auto text-pretty">
                Solusi terdepan untuk memahami dan mengembangkan hubungan
                percintaanmu dengan teknologi AI
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="group relative p-6 rounded-2xl bg-gradient-to-br from-rose-50 to-pink-50 border border-rose-100 hover:border-rose-300 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                ...
                <h3 className="text-lg font-bold mb-2 text-rose-950">
                  Analisis Akurat
                </h3>
                <p className="text-gray-600 text-sm leading-relaxed">
                  Menggunakan algoritma TOPSIS yang terbukti memberikan hasil
                  analisis hubungan yang presisi
                </p>
              </div>
              ...
              <div className="group relative p-6 rounded-2xl bg-gradient-to-br from-pink-50 to-red-50 border border-pink-100 hover:border-pink-300 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Teknologi AI terkini yang memahami konteks hubunganmu untuk
                  memberikan saran personal
                </p>
              </div>
              ...
              <div className="group relative p-6 rounded-2xl bg-gradient-to-br from-red-50 to-rose-50 border border-red-100 hover:border-red-300 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Konsultasi kapan saja kamu butuhkan tanpa perlu menunggu
                  jadwal atau antrian
                </p>
              </div>
              ...
              <div className="group relative p-6 rounded-2xl bg-gradient-to-br from-rose-50 to-red-50 border border-rose-100 hover:border-rose-300 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Data dan percakapanmu aman terlindungi dengan enkripsi tingkat
                  enterprise
                </p>
              </div>
            </div>
        ...
        <section className="relative px-6 py-20 bg-gradient-to-br from-rose-50 via-pink-50 to-red-50">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto text-pretty">
                Teknologi canggih untuk mendukung pengambilan keputusan yang
                tepat dalam hubunganmu
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="group relative p-8 bg-white rounded-3xl border border-rose-100 hover:border-rose-300 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-2xl font-bold mb-4 text-rose-950">
                    Tes Kedekatan TOPSIS
                  </h3>
                  <p className="text-gray-600 leading-relaxed mb-6">
                    Analisis mendalam menggunakan algoritma TOPSIS dengan 15+
                    indikator yang komprehensif untuk mengukur tingkat kecocokan
                    hubunganmu
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      ...
                      <span className="text-sm text-gray-700">
                        15+ indikator hubungan yang tervalidasi
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-5 h-5 rounded-full bg-rose-100 flex items-center justify-center flex-shrink-0 mt-0.5">
                      ...
                      <span className="text-sm text-gray-700">
                        Visualisasi skor yang mudah dipahami
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-5 h-5 rounded-full bg-rose-100 flex items-center justify-center flex-shrink-0 mt-0.5">
              ...
              <div className="group relative p-8 bg-white rounded-3xl border border-pink-100 hover:border-pink-300 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-gray-600 leading-relaxed mb-6">
                    Konsultasi 24/7 dengan AI yang dilatih khusus untuk memahami
                    dinamika hubungan dan memberikan saran yang personal
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <span className="text-sm text-gray-700">
                        Tersedia kapan saja kamu butuhkan
                      </span>
                    </li>
                  </ul>
                </div>
            ...
            <div className="mt-16 text-center">
              <div className="inline-block p-1 rounded-3xl bg-gradient-to-r from-rose-500 via-pink-500 to-red-500 shadow-2xl">
                <div className="px-12 py-8 bg-white rounded-[22px] space-y-4">
                  <h3 className="text-2xl md:text-3xl font-black text-rose-950">
                    Siap Memulai Perjalanan Cintamu?
                  </h3>
                  <p className="text-gray-600 max-w-lg mx-auto text-pretty">
                    Dapatkan insight mendalam tentang hubunganmu dan saran yang
                    tepat untuk langkah selanjutnya
                  </p>
                  <Link
                    href="/test"
                    className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-rose-500 via-pink-500 to-red-500 text-white rounded-xl font-bold text-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
                  >
